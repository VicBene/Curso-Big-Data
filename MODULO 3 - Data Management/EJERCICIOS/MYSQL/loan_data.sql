CREATE TABLE Loan_Data (
    `checking_status` VARCHAR(11) CHARACTER SET utf8,
    `duration` INT,
    `credit_history` VARCHAR(30) CHARACTER SET utf8,
    `purpose` VARCHAR(19) CHARACTER SET utf8,
    `credit_amount` INT,
    `savings_status` VARCHAR(16) CHARACTER SET utf8,
    `employment` VARCHAR(10) CHARACTER SET utf8,
    `installment_commitment` INT,
    `personal_status` VARCHAR(18) CHARACTER SET utf8,
    `other_parties` VARCHAR(12) CHARACTER SET utf8,
    `residence_since` INT,
    `property_magnitude` VARCHAR(17) CHARACTER SET utf8,
    `age` INT,
    `other_payment_plans` VARCHAR(6) CHARACTER SET utf8,
    `housing` VARCHAR(8) CHARACTER SET utf8,
    `existing_credits` INT,
    `job` VARCHAR(25) CHARACTER SET utf8,
    `num_dependents` INT,
    `own_telephone` VARCHAR(4) CHARACTER SET utf8,
    `foreign_worker` VARCHAR(3) CHARACTER SET utf8,
    `class` VARCHAR(4) CHARACTER SET utf8
);
INSERT INTO Loan_Data VALUES ('no checking',24,'existing paid','used car',5433,'no known savings','unemployed',2,'female div/dep/mar','none',4,'life insurance',26,'none','rent',1,'high qualif/self emp/mgmt',1,'yes','yes','good'),
...
INSERT INTO Loan_Data VALUES ('0<=X<200',30,'existing paid','radio/tv',1715,'no known savings','1<=X<4',4,'female div/dep/mar','none',1,'car',26,'none','own',1,'skilled',1,'none','yes','good'),
...
INSERT INTO Loan_Data VALUES ('0<=X<200',36,'existing paid','new car',14318,'<100','>=7',4,'male single','none',2,'no known property',57,'none','for free',1,'high qualif/self emp/mgmt',1,'yes','yes','bad'),
...
INSERT INTO Loan_Data VALUES ('<0',12,'critical/other existing credit','new car',4843,'<100','>=7',3,'male single','co applicant',4,'life insurance',43,'none','rent',2,'skilled',1,'yes','yes','bad'),
